...
//                .body(CheckOutTelCoObj.postBodyNewCheckoutTelCo((context.getAttribute("itemId").toString()), (context.getAttribute("billId").toString()),  (context.getAttribute("tranData").toString())))
//                .log().all()
//                .when().post()
//                .then()
//                .extract().response();
