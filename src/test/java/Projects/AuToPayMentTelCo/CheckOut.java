...
import Objects.PayMentTelCo.CheckOutTelCoObj;
...
public class CheckOut {
    ...
    public void CheckOut(ITestContext context) {
        Response response = given()
                ...
                .body(CheckOutTelCoObj.postBodyCheckoutTelCo((context.getAttribute("productId").toString()), (context.getAttribute("itemId").toString())))
                .log().all()
                .when().post()
                .then()
                .extract().response();
