...
public class RiskRuleChangeDevideConditional {
    @BeforeClass
    static void init() {
    ...
    @Test
    @Parameters({"user", "amount", "equal", "purpose", "option"})
    public void CheckUserRiskConditional(String user, int amount, int equal, String purpose, String option){
